...
function setTestMode(e) {
    window.document.getElementById("test_mode_name").innerText = e;
    displayReadyButton();
}

function displayReadyButton() {
    if (window.document.getElementById("ready_button_container").style.display == "none") {
        if (window.document.getElementById("test_mode_name").innerText != "Test mode" && window.document.getElementById("params").style.display != "none") {
            window.document.getElementById("ready_button_container").style.display = "inline";
        }
    }
}
